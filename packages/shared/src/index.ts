...
export interface AiFinding { readonly id: string; readonly path: string; readonly line: number; readonly side: Side; readonly body: string; readonly severity: 'info' | 'warning' | 'error'; readonly anchorCommit: string; readonly reviewId?: string }
